...
import { currentProviderUrlModule } from "app/shared/currentProviderUrl/currentProviderUrlModule";
...
const ethCommonPlugin: IPlugin = {
    init(config, api, logger, publicPath) {
        ...
        api.addModuleDef("module://aleth.io/dashboard/currentProviderUrl", currentProviderUrlModule);
    },
